...
<title>Item Entry Success</title>
<style type="text/css">
...
<body>
  ...
  <tr>
    ...
    <td><span>${curewellinvoiceordervo.invoicedate}</span></td>
    <td><span>${curewellinvoiceordervo.ponumber}</span></td>
    <td><span>${curewellinvoiceordervo.podate}</span></td>
    <td><span>${curewellinvoiceordervo.partytobill}</span></td>
    <td><span>${curewellinvoiceordervo.partyaddress}</span></td>
    <td><span>${curewellinvoiceordervo.partygstn}</span></td>
    <td><span>${curewellinvoiceordervo.partystate}</span></td>
    <td><span>${curewellinvoiceordervo.statecode}</span></td>
    <td><span>${curewellinvoiceordervo.advancepaid}</span></td>
    <td><span>${curewellinvoiceordervo.outstandingamount}</span></td>
    <td><span>${curewellinvoiceordervo.shiptopartyname}</span></td>
    <td><span>${curewellinvoiceordervo.supplyplace}</span></td>
